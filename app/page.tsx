...
export default function Home() {
  ...
  const comfort = getComfortAssessment(
    data.env.roomTemp,
    data.env.roomHumidity,
    data.env.pressure ?? 1009.1
  );
      ...
      <main className="flex-1 overflow-y-auto px-4 pt-4 pb-28">
        <div className="max-w-md mx-auto space-y-5">
          ...
          <header className="flex items-center justify-between pt-1">
            ...
            {/* Header controls: Feedback sound toggle + Notification bell */}
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <span className="text-[10px] uppercase font-bold text-neutral-400 block leading-tight">Temp</span>
                <span className="text-xs font-bold text-white block leading-snug">{data.env.roomTemp.toFixed(1)}°C</span>
                <span className="text-[9px] text-orange-400 font-semibold block leading-none">Feels {comfort.feelsLike}°</span>
              </div>
            </Link>
            ...
            >
              ...
              <div className="text-left">
                <span className="text-[10px] uppercase font-bold text-neutral-400 block leading-tight">Humidity</span>
                <span className="text-xs font-bold text-white block leading-snug">{data.env.roomHumidity.toFixed(0)}%</span>
                <span className={`text-[9px] font-semibold block leading-none ${comfort.moldRiskColor}`}>
                  {comfort.moldRiskScore >= 60 ? "Mold Risk" : "Air: Safe"}
                </span>
              </div>
            </Link>
            ...
            >
              ...
              <div className="text-left">
                <span className="text-[10px] uppercase font-bold text-neutral-400 block leading-tight">Power</span>
                <span className="text-xs font-bold text-white block leading-snug">{data.power.power.toFixed(0)}W</span>
                <span className="text-[9px] text-neutral-400 font-semibold block leading-none">
                  {data.power.pf >= 0.85 ? "Clean PF" : `${data.power.pf.toFixed(2)} PF`}
                </span>
              </div>
            </Link>
          </section>
